...
# Config
input_file = "Table-All-Models-For-Analyze.xlsx"
...
fig.suptitle("Evaluation of 12 Language Models' Predictions of Table Carbon Footprint (kg CO₂e)", fontsize=12)
plt.tight_layout()
...
output_png = f"table_models_rows_{tag}.png"
