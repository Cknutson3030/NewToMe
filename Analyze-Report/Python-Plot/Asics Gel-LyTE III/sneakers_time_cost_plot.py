...
input_file = "Sneakers-Token-time.xlsx"
output_png = "sneakers_time_cost_plot.png"
...
if not os.path.exists(input_file):
    ...
    fallback = None
    # Prefer files that mention 'time' (e.g., 'Sneakers-Token,time.xlsx'), then 'sneakers'
    for pattern in ("time", "token,time", "sneakers"):
        for f in xlsx_files:
...
ax.set_title("Model Efficiency Trade-off: Mean Latency vs. Cost for Sneakers")

plt.tight_layout()
bubble_png = "sneakers_models_bubble.png"
