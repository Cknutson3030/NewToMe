...
# Config
input_file = "Sneaker-All-Models-For-Analyze.xlsx"
...
fig.suptitle("Evaluation of 12 Language Models' Predictions of Sneakers Carbon Footprint (kg CO₂e)", fontsize=12)
plt.tight_layout()
...
output_png = f"sneakers_models_rows_{tag}.png"
