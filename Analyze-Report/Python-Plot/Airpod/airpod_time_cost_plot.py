...
input_file = "Airpod-Token-time.xlsx"
output_png = "airpod_time_cost_plot.png"
...
if not os.path.exists(input_file):
    ...
    fallback = None
    # Prefer files that mention 'time' (e.g., 'Airpod-Token,time.xlsx'), then 'airpod'
    for pattern in ("time", "token,time", "airpod"):
        for f in xlsx_files:
...
ax.set_title("Model Efficiency Trade-off: Mean Latency vs. Cost for AirPods Pro 3")

plt.tight_layout()
bubble_png = "airpod_models_bubble.png"
