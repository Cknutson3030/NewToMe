...
# Config
input_file = "Airpod-All-Models-For-Analyze.xlsx"
...
fig.suptitle("Evaluation of 12 Language Models' Predictions of AirPods Pro 3 Carbon Footprint (kg CO₂e)", fontsize=12)
plt.tight_layout()
...
output_png = f"airpod_models_rows_{tag}.png"
