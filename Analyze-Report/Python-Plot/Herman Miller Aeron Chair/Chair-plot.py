...
# Config
input_file = "Chair-All-Models-For-Analyze.xlsx"
...
fig.suptitle("Evaluation of 12 Language Models' Predictions of Chair Carbon Footprint (kg CO₂e)", fontsize=12)
plt.tight_layout()
...
output_png = f"chair_models_rows_{tag}.png"
