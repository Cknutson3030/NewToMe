...
input_file = "Chair-Token-time.xlsx"
output_png = "chair_time_cost_plot.png"
...
if not os.path.exists(input_file):
    ...
    fallback = None
    # Prefer files that mention 'time' (e.g., 'Chair-Token,time.xlsx'), then 'chair'
    for pattern in ("time", "token,time", "chair"):
        for f in xlsx_files:
...
ax.set_title("Model Efficiency Trade-off: Mean Latency vs. Cost for Chair")

plt.tight_layout()
bubble_png = "chair_models_bubble.png"
