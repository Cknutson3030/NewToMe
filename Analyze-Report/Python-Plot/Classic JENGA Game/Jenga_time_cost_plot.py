...
input_file = "Jenga-Token-time.xlsx"
output_png = "jenga_time_cost_plot.png"
...
if not os.path.exists(input_file):
    ...
    fallback = None
    # Prefer files that mention 'time' (e.g., 'Jenga-Token,time.xlsx'), then 'jenga'
    for pattern in ("time", "token,time", "jenga"):
        for f in xlsx_files:
...
ax.set_title("Model Efficiency Trade-off: Mean Latency vs. Cost for Jenga")

plt.tight_layout()
bubble_png = "jenga_models_bubble.png"
