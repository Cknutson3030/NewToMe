...
input_file = "SodaStream-Token-time.xlsx"
output_png = "sodastream_time_cost_plot.png"
...
if not os.path.exists(input_file):
    ...
    fallback = None
    # Prefer files that mention 'time' (e.g., 'SodaStream-Token,time.xlsx'), then 'sodastream'
    for pattern in ("time", "token,time", "sodastream"):
        for f in xlsx_files:
...
ax.set_title("Model Efficiency Trade-off: Mean Latency vs. Cost for SodaStream")

plt.tight_layout()
bubble_png = "sodastream_models_bubble.png"
